...
const Navbar = () => {
    ...
    return (
        <nav className="navbar py-2 fixed top-4 left-0 w-full z-50 bg-white bg-opacity-10 backdrop-filter backdrop-blur-xlg transition-all duration-300">
            <div className="container mx-auto flex justify-between items-center px-4 py-2">
                ...
                <div className="hidden md:flex text-white font-bold gap-6 justify-center flex-grow">
                ...
                <div className="flex items-center">
                    <div className="relative">
                        <input
                            type="text"
                            placeholder="Search..."
                            className="px-4 py-1 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-white bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg placeholder-white"
                        />
                        <FontAwesomeIcon icon={faSearch} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white" />
                    </div>
                </div>
